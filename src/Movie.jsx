  ...
  return (
    <>
      <div id='container'>
        ...
        <input id='form' className='form-control p-2 ' placeholder='Enter a movie name' type="text" onChange={(e)=>setMovieName(e.target.value)}/>
        </div>
        <div className='d-flex justify-content-center mt-3'> 
        <button id='btn'  className='btn btn-light' onClick={setSearch} variant="warning">search</button>
     ...
     movieDetails? (
      <div>
        ...
        <Card style={{ width: '20rem',border:'none',borderRadius:'30px 0 0 0' }}>
      <Card.Img style={{borderRadius:'30px',borderStyle:'ridge'}} className='poster mt-4' variant="top"  src={movieDetails.Poster} />
      <Card.Body>
      </Card.Body>
    </Card>


    <Card style={{ width: '20rem',border:'none',borderRadius:'0' }}>
